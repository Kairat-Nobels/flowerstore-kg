  ...
  return (
    <Table bordered cellBordered data={data} autoHeight wordWrap="break-word">
      ...
      <Table.Column width={120}>
        <Table.HeaderCell>Сүрөт</Table.HeaderCell>
        <Table.Cell>
          {(rowData) => (
            <img
              src={rowData.image}
      ...
      <Table.Column width={100}>
        <Table.HeaderCell>Эски баа</Table.HeaderCell>
        <Table.Cell>
          {(rowData) =>
            rowData?.oldPrice ? rowData?.oldPrice + ' сом' : '-----'
          }
        </Table.Cell>
      </Table.Column>

      <Table.Column width={100}>
        <Table.HeaderCell>Баасы</Table.HeaderCell>
        <Table.Cell>
